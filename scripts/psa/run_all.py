...
import logging
import random
from mcbo.scms.functions import PSAGraph
import warnings
...
def toygraph_config(budget: int, kappa: int, mc_samples: int, l :int, obs_cost: float,
    ...
    eps_noise_terms = [0.05, 0.05, 0.05, 0.05, 1, 1.5, 1.5, 0.05]
    ...
    # Costs
    intervention_vars_costs = {"A": intervene_cost, "B": intervene_cost, "C": intervene_cost, "D": intervene_cost,
                               "E": intervene_cost, "F": intervene_cost}
    observation_vars_costs = {"A": obs_cost, "B": obs_cost, "C": obs_cost, "D": obs_cost, "E": obs_cost, "F": obs_cost}

    # Initialize SCM
    toy_scm = PSASCM(gp_config=gp_config,
    ...
    cbo_config = CBOConfig(scm=toy_scm, num_obs_per_observation=num_obs_per_observation,
                           ...
                           acquisition_function_type=AcquisitionFunctionType.CAUSAL_EXPECTED_IMPROVEMENT,
...
if __name__ == '__main__':
    ...
    evaluation_budgets = [150, 300, 450]
    l_values = [1]
    mc_samples_values = [1]
    kappa_values = [0]
                                        ...
                                        for observation_cost in observation_costs:
                                            for kappa in kappa_values:
                                                ...
                                                mcbo_trial(
                                                    ...
                                                    budget = budget,
                                                    variables = cbo_config.scm.variables, cbo_config=cbo_config
                                                )
